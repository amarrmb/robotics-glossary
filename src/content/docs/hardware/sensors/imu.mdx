...
- [ROS 2 sensor_msgs/Imu](https://docs.ros2.org/latest/api/sensor_msgs/msg/Imu.html) — Standard IMU message definition
- [robot_localization](https://index.ros.org/p/robot_localization/) — EKF/UKF fusion package documentation
- [imu_filter_madgwick](https://docs.ros.org/en/ros2_packages/humble/api/imu_filter_madgwick/) — Madgwick filter for orientation
- [Isaac ROS Visual SLAM](https://github.com/NVIDIA-ISAAC-ROS/isaac_ros_visual_slam) — GPU-accelerated VIO with IMU fusion
- [TDK InvenSense MPU-6050](https://product.tdk.com/en/search/sensor/mortion-inertial/imu/info?part_no=MPU-6050) — Consumer IMU datasheet
- [TDK InvenSense ICM-42688-P](https://invensense.tdk.com/products/motion-tracking/6-axis/icm-42688-p/) — Industrial IMU specifications
- [Bosch Sensortec BMI088](https://www.bosch-sensortec.com/products/motion-sensors/imus/bmi088/) — Industrial IMU for drones
