...
- [NVIDIA Isaac ROS GitHub](https://github.com/NVIDIA-ISAAC-ROS) — Source code, package repositories
- [JetPack SDK](https://developer.nvidia.com/embedded/jetpack) — Platform support matrix
