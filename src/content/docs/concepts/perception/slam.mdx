...
<Tabs>
  ...
  <TabItem label="LiDAR SLAM">
    ...
    **Approaches:**
    - **2D LiDAR**: Hector SLAM, GMapping, SLAM Toolbox
  ...
  <TabItem label="Visual-Inertial">
    ...
    **Approaches:**
    - **Tightly-coupled**: VINS-Mono, OKVIS (ROS 1 focused)
...
- [Isaac ROS Visual SLAM](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_visual_slam/index.html) — cuVSLAM documentation, multi-camera support, and KITTI benchmarks
- [cuVSLAM Concepts](https://nvidia-isaac-ros.github.io/concepts/visual_slam/cuvslam/index.html) — GPU-accelerated SLAM architecture and IMU fusion
- [Isaac ROS nvblox](https://nvidia-isaac-ros.github.io/repositories_and_packages/isaac_ros_nvblox/index.html) — 3D reconstruction with TSDF, multi-sensor support
- [SLAM Toolbox (ROS 2)](https://docs.ros.org/en/jazzy/p/slam_toolbox/) — Actively maintained 2D SLAM for ROS 2 (Jazzy 2.8.3)
- [ORB-SLAM3 Paper](https://arxiv.org/abs/2007.11898) — Visual-inertial SLAM with multi-map support
- [DROID-SLAM](https://github.com/princeton-vl/DROID-SLAM) — Deep learning-based dense SLAM
