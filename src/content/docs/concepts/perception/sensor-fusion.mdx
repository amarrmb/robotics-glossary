...
<Aside type="note">
The tabs below describe how each filter is *applied to multiple sensors*. For how the filter itself works — the predict/update cycle and the Kalman gain — see [Kalman Filter](/robotics-glossary/concepts/control/kalman-filter/).
</Aside>
