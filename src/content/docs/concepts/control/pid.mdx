...
- **[Model Predictive Control (MPC)](/robotics-glossary/concepts/control/mpc/)** — handles constraints and multi-variable systems
- **[LQR](/robotics-glossary/concepts/control/lqr/)** — optimal control for linear systems
...
- [PID Controller - ros2_control (v6.2.0)](https://control.ros.org/rolling/doc/ros2_controllers/pid_controller/doc/userdoc.html) — ROS 2 implementation with anti-windup strategies
