...
- [GR00T N1.6 Sim-to-Real Blog](https://developer.nvidia.com/blog/building-generalist-humanoid-capabilities-with-nvidia-isaac-gr00t-n1-6-using-a-sim-to-real-workflow) — GR00T N1.6 with Cosmos Reason integration
- [OpenVLA Paper](https://arxiv.org/abs/2406.09246) — Open-source 7B VLA model architecture
- [RT-2 Blog](https://deepmind.google/blog/rt-2-new-model-translates-vision-and-language-into-action/) — Google DeepMind VLA model
- [Octo Paper](https://arxiv.org/abs/2405.12213) — Generalizable manipulation policy
- [TensorRT SDK](https://developer.nvidia.com/tensorrt) — Model optimization for inference
- [NVIDIA Jetson Modules](https://developer.nvidia.com/embedded/jetson-modules) — Hardware specifications
