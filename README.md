...
# Why this exists?
Robotics spans many disciplines—control theory, computer vision, embedded systems, AI, and mechanical engineering.
As a result:
1) The same term can mean different things in different contexts
2) Important concepts are scattered across textbooks, wikis, and vendor docs
3) Beginners struggle to build a mental map of how concepts relate
